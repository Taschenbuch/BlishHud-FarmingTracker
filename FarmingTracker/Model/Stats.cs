...
// - out of sync / corrupt stats because multiple threads are modifing the data and another thread tries to update the ui with that data.
...
// - Snapshot: To prevent that itemById and currencyById are out of sync, a local variable of StatsSnapshot has to be created first, when trying to access both.
...
namespace FarmingTracker
{
    public class Stats
    {
        ...
        // Must not be called while other threads modify CurrencyById/ItemById not be done by multipel threads. Read currencyById comment for details.
