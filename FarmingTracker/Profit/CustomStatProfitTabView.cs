...
namespace FarmingTracker
{
    public class CustomStatProfitTabView : View
    {
        ...
        protected override void Build(Container buildPanel)
        {
            ...
            var statsWithCustomProfit = _model.Stats.GetStats().Where(s => s.Profit.HasCustomProfit);
        ...
        {
            var statsWithCustomProfit = model.Stats.GetStats().Where(s => s.Profit.HasCustomProfit);
