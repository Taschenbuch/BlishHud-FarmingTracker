...
namespace FarmingTracker
{
    public class CustomStatProfitTabView : View
    {
        ...
        protected override void Build(Container buildPanel)
        {
            ...
            var statsWithCustomProfit = _model.Stats.StatById.Values.Where(s => s.Profit.HasCustomProfit); // todo x lock?
        ...
        {
            var statsWithCustomProfit = model.Stats.StatById.Values.Where(s => s.Profit.HasCustomProfit); // todo x lock?
