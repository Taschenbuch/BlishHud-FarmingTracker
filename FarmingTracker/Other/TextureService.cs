...
namespace FarmingTracker
{
    public class TextureService : IDisposable
    {
        public TextureService(ContentsManager contentsManager)
        {
            ...
            SessionSummaryTabIconTexture = contentsManager.GetTexture(@"session-summary-tab-icon.png");
        ...
        public void Dispose()
        {
            ...
            SessionSummaryTabIconTexture?.Dispose();
        ...
        public Texture2D SessionSummaryTabIconTexture { get; }
